...
# GaitGraph1
## phase1
# CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --master_port=$MASTER_PORT --nproc_per_node=4 fastposegait/main.py --cfgs ./configs/gaitgraph1/gaitgraph1_phase1_OUMVLP.yaml --phase train --log_to_file

# GaitGraph2
# CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --master_port=$MASTER_PORT --nproc_per_node=4 fastposegait/main.py --cfgs ./configs/gaitgraph2/gaitgraph2_OUMVLP.yaml --phase train --log_to_file
...
# GaitGraph1
## phase1
# CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --master_port=$MASTER_PORT --nproc_per_node=4 fastposegait/main.py --cfgs ./configs/gaitgraph1/gaitgraph1_phase1_Gait3D.yaml --phase train --log_to_file


# GaitGraph2
# CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --master_port=$MASTER_PORT --nproc_per_node=4 fastposegait/main.py --cfgs ./configs/gaitgraph2/gaitgraph2_Gait3D.yaml --phase train --log_to_file
...
# GaitGraph2
# CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --master_port=$MASTER_PORT --nproc_per_node=4 fastposegait/main.py --cfgs ./configs/gaitgraph2/gaitgraph2_GREW.yaml --phase train --log_to_file
